...
namespace Crater\Services\Module {
    ...
    /**
     * @see Module::allScripts
     * @method static array allScripts()
     * @see Module::allStyles
     * @method static array allStyles()
     * @see Module::style
     * @method static Module style(string $name, string $path)
     * @see Module::script
     * @method static Module script(string $name, string $path)
     */
    class ModuleFacade {}
}
...
namespace Lavary\Menu {
    ...
    /**
     * @see Menu::all
     * @method static \Illuminate\Support\Collection|Collection all()
     * @see Menu::getCollection
     * @method static \Illuminate\Support\Collection|Collection getCollection()
     * @see Menu::loadConf
     * @method static array loadConf(string $name)
     * @see Menu::get
     * @method static Builder get(string $key)
     * @see Menu::makeOnce
     * @method static Builder|null makeOnce(string $name, callable $callback)
     * @see Menu::exists
     * @method static bool exists(string $name)
     * @see Menu::make
     * @method static Builder|null make(string $name, callable $callback, array $options = [])
     */
    class Facade {}
}
...
namespace Silber\Bouncer {
    ...
    /**
     * @see Bouncer::forbidEveryone
     * @method static \Silber\Bouncer\Conductors\ForbidsAbilities|\Silber\Bouncer\Conductors\GivesAbilities forbidEveryone()
     * @see Bouncer::allow
     ...
     * @see Bouncer::disallowEveryone
     * @method static \Silber\Bouncer\Conductors\RemovesAbilities disallowEveryone()
     * @see Bouncer::forbid
     * @method static \Silber\Bouncer\Conductors\ForbidsAbilities|\Silber\Bouncer\Conductors\GivesAbilities forbid(\Illuminate\Database\Eloquent\Model|string $authority)
     * @see Bouncer::denies
     * @method static bool denies(string $ability, array|mixed $arguments = [])
     * @see Bouncer::dontCache
     * @method static Bouncer dontCache()
     * @see Bouncer::can
     * @method static bool can(string $ability, array|mixed $arguments = [])
     * @see Bouncer::disallow
     * @method static \Silber\Bouncer\Conductors\RemovesAbilities disallow(\Illuminate\Database\Eloquent\Model|string $authority)
     * @see Bouncer::tables
     * @method static Bouncer tables(array $map)
     * @see Bouncer::ownedVia
     * @method static Bouncer ownedVia(\Closure|string $model, \Closure|null|string $attribute = null)
     * @see Bouncer::registerClipboardAtContainer
     * @method static Bouncer registerClipboardAtContainer()
     * @see Bouncer::getClipboard
     * @method static \Silber\Bouncer\Contracts\Clipboard getClipboard()
     * @see Bouncer::scope
     * @method static mixed scope(\Silber\Bouncer\Contracts\Scope $scope = null)
     * @see Bouncer::useAbilityModel
     * @method static Bouncer useAbilityModel(string $model)
     * @see Bouncer::define
     * @method static Bouncer define(string $ability, callable|string $callback)
     * @see Bouncer::create
     * @method static Bouncer create($user = null)
     * @see Bouncer::usesCachedClipboard
     * @method static bool usesCachedClipboard()
     * @see Bouncer::ability
     * @method static \Silber\Bouncer\Database\Ability ability(array $attributes = [])
     * @see Bouncer::unforbid
     * @method static \Silber\Bouncer\Conductors\RemovesAbilities|\Silber\Bouncer\Conductors\UnforbidsAbilities unforbid(\Illuminate\Database\Eloquent\Model|string $authority)
     * @see Bouncer::make
     * @method static Factory make($user = null)
     * @see Bouncer::authorize
     * @method static \Illuminate\Auth\Access\Response authorize(string $ability, array|mixed $arguments = [])
     * @see Bouncer::setClipboard
     * @method static Bouncer setClipboard(\Silber\Bouncer\Contracts\Clipboard $clipboard)
     * @see Bouncer::refreshFor
     * @method static Bouncer refreshFor(\Illuminate\Database\Eloquent\Model $authority)
     * @see Bouncer::allows
     * @method static bool allows(string $ability, array|mixed $arguments = [])
     * @see Bouncer::runAfterPolicies
     * @method static Bouncer runAfterPolicies(bool $boolean = true)
     * @see Bouncer::cache
     * @method static Bouncer cache(\Illuminate\Contracts\Cache\Store $cache = null)
     * @see Bouncer::canAny
     * @method static bool canAny(array $abilities, array|mixed $arguments = [])
     * @see Bouncer::unforbidEveryone
     * @method static \Silber\Bouncer\Conductors\RemovesAbilities|\Silber\Bouncer\Conductors\UnforbidsAbilities unforbidEveryone()
     * @see Bouncer::refresh
     * @method static Bouncer refresh(\Illuminate\Database\Eloquent\Model $authority = null)
     * @see Bouncer::is
     ...
     * @see Bouncer::useUserModel
     * @method static Bouncer useUserModel(string $model)
     * @see Bouncer::setGate
     * @method static Bouncer setGate(\Illuminate\Contracts\Auth\Access\Gate $gate)
     * @see Bouncer::retract
     ...
     * @see Bouncer::gate
     * @method static \Illuminate\Contracts\Auth\Access\Gate|null gate()
     * @see Bouncer::allowEveryone
     * @method static \Silber\Bouncer\Conductors\GivesAbilities allowEveryone()
     * @see Bouncer::useRoleModel
     * @method static Bouncer useRoleModel(string $model)
     * @see Bouncer::assign
     * @method static \Silber\Bouncer\Conductors\AssignsRoles assign(\Illuminate\Support\Collection|\Silber\Bouncer\Database\Role|string $roles)
     */
    class BouncerFacade {}
}
...
namespace {
    ...
    class Vite extends Innocenzi\Vite\ViteFacade {}
}