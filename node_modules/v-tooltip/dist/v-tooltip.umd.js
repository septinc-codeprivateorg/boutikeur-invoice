(function (global, factory) {
  ...
  */
  ...
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, [vue.createVNode("div", _hoisted_1$1, [vue.createVNode("div", _hoisted_2, [$props.mounted ? (vue.openBlock(), vue.createBlock(vue.Fragment, {
      key: 0
    }, [vue.createVNode("div", null, [vue.renderSlot(_ctx.$slots, "default")]), $props.handleResize ? (vue.openBlock(), vue.createBlock(_component_ResizeObserver, {
      key: 0,
    ...
    /* NEED_PATCH */
    ), vue.createVNode("div", _hoisted_3, [_hoisted_4], 512
    /* NEED_PATCH */
    )])], 42
  ...
  script$1.__file = "src/components/PopperContent.vue";
  ...
  script$2.__file = "src/components/PopperWrapper.vue";

  var script$3 = _objectSpread2(_objectSpread2({}, script$2), {}, {
    name: 'VDropdown',
  ...
  var script$4 = _objectSpread2(_objectSpread2({}, script$2), {}, {
    name: 'VMenu',
    vPopperTheme: 'menu'
  });

  script$4.__file = "src/components/Menu.vue";

  var script$5 = _objectSpread2(_objectSpread2({}, script$2), {}, {
    name: 'VTooltip',
    vPopperTheme: 'tooltip'
  });

  script$5.__file = "src/components/Tooltip.vue";
    ...
    return vue.openBlock(), vue.createBlock(_component_Popper, vue.mergeProps({
      ...
      default: vue.withCtx(function (_ref) {
        ...
        return [vue.createVNode(_component_PopperContent, {
          ...
          default: vue.withCtx(function () {
            return [$props.html ? (vue.openBlock(), vue.createBlock("div", {
              key: 0,
              innerHTML: $options.finalContent
            }, null, 8
            /* PROPS */
            , ["innerHTML"])) : (vue.openBlock(), vue.createBlock("div", {
              key: 1,
  ...
  script$6.__file = "src/components/TooltipDirective.vue";
  ...
  function createTooltip(el, value, modifiers) {
    ...
    var tooltipApp = el.$_popper = vue.createApp({
      name: 'VTooltipDirective',
      data: function data() {
        return {
          options: options
      ...
      render: function render() {
        return vue.h(script$6, _objectSpread2(_objectSpread2({}, this.options), {}, {
          ref: 'tooltip'
        }));
      }
    });
  ...
  var PopperContent = script$1;
  var PopperMethods = PrivatePopperMethods;
  var PopperWrapper = script$2;
  var ThemeClass = PrivateThemeClass;
  var Tooltip = script$5;
  var TooltipDirective = script$6;
  /* Vue plugin */
  ...
  function install(app) {
    ...
    app.component('v-tooltip', script$5);
    app.component('VTooltip', script$5); // eslint-disable-next-line vue/component-definition-name-casing
    ...
    app.component('v-menu', script$4);
    app.component('VMenu', script$4);
  }
  var plugin = {
