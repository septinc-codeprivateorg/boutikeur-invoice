'use strict';Object.defineProperty(exports,'__esModule',{value:true});require('core-js/modules/es.object.keys.js'),require('core-js/modules/es.object.to-string.js'),require('core-js/modules/es.regexp.constructor.js'),require('core-js/modules/es.regexp.exec.js'),require('core-js/modules/es.regexp.to-string.js');function _typeof(obj) {
...
})(exports.StorageType || (exports.StorageType = {}));var webStorage = new StorageClass();
var Vue3Storage = {
  install: function install(app, options) {
    var _options$namespace;

    var _options = {
      storage: (options === null || options === void 0 ? void 0 : options.storage) || exports.StorageType.Local,
...
var useStorage = function useStorage() {
  ...
  return webStorage;
};exports.default=Vue3Storage;exports.useStorage=useStorage;